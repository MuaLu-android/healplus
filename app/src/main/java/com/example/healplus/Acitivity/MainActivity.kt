...
fun MainApp(modifier: Modifier = Modifier, authViewModel: AuthViewModel){
    ...
    LaunchedEffect(navController.currentBackStackEntry) {
        ...
        Log.d("Navigation", "Màn hình hiện tại: $currentRoute")
    ...
    Scaffold(
        ...
        bottomBar = {
            if (authState is AuthSate.Authenticated && currentRoute != "detail/{itemsModel}" && currentRoute != "cart") { // Kiểm tra đăng nhập
                NavigationBar {
